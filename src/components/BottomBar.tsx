...
import { Calendar, ChevronDown, Mic, Send, Sparkles, Plus, Search } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex-1 max-w-2xl mx-4">
          <div className="bg-slate-800 border border-slate-700 rounded-full px-6 py-3 flex items-center gap-3">
            <input
              type="text"
              placeholder="Ask AI: Add lead, find follow-ups, get summary..."
        ...
        <button className="bg-blue-600 hover:bg-blue-700 rounded-full p-3 text-white transition-colors">
